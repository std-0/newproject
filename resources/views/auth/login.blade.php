...
@section('content')
    <div class="h-screen flex flex-col space-y-10 justify-center items-center">
        <div class="w-96 shadow-xl rounded p-5">
            <h1 class="text-3xl font-medium">Autentificare</h1>
            <form method="POST" action="{{ route("login_process") }}" class="space-y-5 mt-5">
                ...
                <button type="submit" class="text-center w-full bg-blue-900 rounded-md text-white py-3 font-medium">Conectează-te</button>
            </form>
        </div>
    </div>
@endsection