            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register_process') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-6 col-form-label text-md-right" style="margin-bottom: 15px;">{{ __('E-Mail Address')
                                }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-6 col-form-label text-md-right" style="margin-bottom: 15px;">{{ __('Password')
                                }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-6 col-form-label text-md-right">{{ __('Confirm
                                Password') }}</label>
